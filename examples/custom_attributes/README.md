...
The NRQL alert condition defines both a critical violation block and a warning violation block.  It also changes multiple attributes from their default values.
...
| <a name="requirement_newrelic"></a> [newrelic](#requirement\_newrelic) | >=3.14.0 |

## Providers

| Name | Version |
|------|---------|
| <a name="provider_newrelic"></a> [newrelic](#provider\_newrelic) | >=3.14.0 |
